...
class SettingsPage:
    SETTINGS_GENERAL_LINK = (
        By.CSS_SELECTOR,
        "[data-test-id='navigation-menu-body'] [data-test-id='navigation-menu-item:general']")
    SETTINGS_FOLDERS_LINK = (
        By.CSS_SELECTOR,
        "[data-test-id='navigation-menu-body'] [data-test-id='navigation-menu-item:folders']")
